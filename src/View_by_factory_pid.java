 ...
 * @author MAHE
 */
public class View_by_factory_pid extends javax.swing.JFrame {
    ...
    public void print()
    {
        try
        {
            ...
            String query= "select * from factory, product, waste where factory.p_id = " + View_by_factory.id2 + " and product.p_id = factory.p_id and waste.f_id = factory.f_id;";
    ...
    /**
     * Creates new form View_by_factory_pid
     */
    public View_by_factory_pid() {
        initComponents();
        print();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            ...
            String query= "select * from factory, product, waste where factory.p_id = " + enter.getText() + " and product.p_id = factory.p_id and waste.f_id = factory.f_id;";
            ResultSet rs = st.executeQuery(query);
...
this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_by_factory_pid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
