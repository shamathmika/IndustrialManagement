 ...
 * @author MAHE
 */
public class View_man_supplier_table extends javax.swing.JFrame {
public void print()
    {
        try
        {
            ...
            String query= "select * from supplier, purchase, factory where supplier.s_id = purchase.s_id and purchase.f_id = factory.f_id and factory.f_id = " + Manager.f_id + ";";
            ResultSet rs = st.executeQuery(query);
            
            while(rs.next())                                                                         //going to each row
            {
                int d1=rs.getInt("s_id");
                String d2=rs.getString("s_name");
                int d3 = rs.getInt("f_id");
                String d4=rs.getString("f_name");
                float d6=rs.getFloat("s_price");
                String d7=rs.getString("reliability");
                String d5=rs.getString("raw_material");
                String d8=rs.getString("contact");
                String d9=rs.getString("city");
                int d10=rs.getInt("quantity");
                String d11=rs.getDate("date_of_purchase").toString();
    ...
    /**
     * Creates new form View_man_supplier_table
     */
    public View_man_supplier_table() {
        initComponents();
        print();
    }
    ...
    private void initComponents() {
        ...
        id_view.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Supplier ID", "Name", "Factory ID", "Factory Name", "Raw material", "Price", "Reliability", "Contact", "City", "Quantity", "Date of Purchase"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_man_supplier_table.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
