 ...
 * @author MAHE
 */
public class View_by_product_rawmat extends javax.swing.JFrame {
    ...
    public void print()
    {
        try
        {
            ...
            String query= "select * from product where raw_material = '" + View_by_product.rawmat1 + "';";
    ...
    /**
     * Creates new form View_by_product_rawmat
     */
    public View_by_product_rawmat() {
        initComponents();
        print();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Enter another raw material:");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            ...
            String query= "select * from product where raw_material = '" + enter.getText() + "';";
            ResultSet rs = st.executeQuery(query);
...
this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_by_product_rawmat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
