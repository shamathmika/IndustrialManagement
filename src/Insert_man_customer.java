 ...
 * @author MAHE
 */
public class Insert_man_customer extends javax.swing.JFrame {
    ...
    int p_id;
    /**
     * Creates new form Insert_man_customer
     */
    public Insert_man_customer() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Customer insertion (Manager)");
    ...
    private void insert_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insert_buttonActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(this, "Product not available. Try again later.");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Insert_man_customer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
