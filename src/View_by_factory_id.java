 ...
 * @author MAHE
 */
public class View_by_factory_id extends javax.swing.JFrame {
    ...
    public void print()
    {
        try
        {
            ...
            String query= "select * from factory, product, waste where factory.f_id = " + View_by_factory.id1 + " and product.p_id = factory.p_id and waste.f_id = factory.f_id;";
    ...
    /**
     * Creates new form View_by_factory_id
     */
    public View_by_factory_id() {
        initComponents();
        print();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            ...
            String query= "select * from factory, product, waste where factory.f_id = " + enter.getText() + " and product.p_id = factory.p_id and waste.f_id = factory.f_id;";
            ResultSet rs = st.executeQuery(query);
...
this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_by_factory_id.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
