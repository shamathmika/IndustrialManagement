 ...
 * @author MAHE
 */
public class View_supplier_table extends javax.swing.JFrame {
public void print()
    {
        try
        {
            ...
            String query= "select * from supplier, purchase, factory where supplier.s_id = purchase.s_id and purchase.f_id = factory.f_id;";
    ...
    /**
     * Creates new form View_supplier_table
     */
    public View_supplier_table() {
        initComponents();
        print();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_supplier_table.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
