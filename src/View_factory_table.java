 ...
 * @author MAHE
 */
public class View_factory_table extends javax.swing.JFrame {
public void print()
    {
        try
        {
            ...
            String query= "select * from factory, product, waste where product.p_id = factory.p_id and waste.f_id = factory.f_id;";
    ...
    /**
     * Creates new form View_factory_table
     */
    public View_factory_table() {
        initComponents();
        print();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_factory_table.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
