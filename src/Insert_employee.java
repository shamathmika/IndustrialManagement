...
public class Insert_employee extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        f_id_panelLayout.setHorizontalGroup(
            ...
            .addGroup(f_id_panelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(f_id_label, javax.swing.GroupLayout.DEFAULT_SIZE, 76, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        f_id_panelLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, f_id_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addComponent(f_id_text1, javax.swing.GroupLayout.DEFAULT_SIZE, 42, Short.MAX_VALUE))
        );
        ...
        post_panel.setBackground(new java.awt.Color(255, 255, 255));

        post_label.setFont(new java.awt.Font("MS Reference Sans Serif", 0, 11)); // NOI18N
        post_label.setText("Post:");

        post_list.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        post_list.setFont(new java.awt.Font("OCR A Extended", 0, 11)); // NOI18N
        post_list.removeAll();
        post_list.addItem("Choose one:");
        post_list.addItem("Manager");
        post_list.addItem("Worker");
        post_list.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                post_listItemStateChanged(evt);
            }
        });
        ...
        post_panelLayout.setHorizontalGroup(
            ...
            .addGroup(post_panelLayout.createSequentialGroup()
                ...
                .addGap(32, 32, 32)
                .addComponent(post_list, javax.swing.GroupLayout.PREFERRED_SIZE, 122, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        post_panelLayout.setVerticalGroup(
            ...
            .addGroup(post_panelLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(post_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(post_list, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(post_label))
        ...
        purple_panelLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, purple_panelLayout.createSequentialGroup()
                ...
                .addGroup(purple_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    ...
                    .addComponent(post_panel, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        try{
          ...
          // st1.executeUpdate(query1);
            ...
            if(post.equals("Manager"))
            {
                ...
                man_id = name_text.getText();
                man_pass = f_id_text.getText() + "%" + p_id_text.getText();
                Statement st2= conn.createStatement();
                
                String query2 = "insert into login_manager values('" + man_id + "','" + man_pass  + "');";
    ...
    private void f_id_textActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_f_id_textActionPerformed
        if(!f_id_text.getText().isEmpty())
        {
            try{
                ...
                Statement st= conn.createStatement();
                int f = Integer.parseInt(f_id_text.getText());
                String query4 = "select f_id, p_id from factory where f_id = " + f + ";";
                ResultSet rs = st.executeQuery(query4);
                while(rs.next())
                {
                    int fimp = rs.getInt("f_id");
    ...
    private void post_listItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_post_listItemStateChanged

        post = post_list.getSelectedItem();
        if (post.equals("Choose one:"))
            post = null;
        ...
        // TODO add your handling code here:
    }//GEN-LAST:event_post_listItemStateChanged
    ...
    private java.awt.Choice post_list;
