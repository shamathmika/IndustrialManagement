 ...
 * @author MAHE
 */
public class View_by_product_units extends javax.swing.JFrame {
    ...
    public void print()
    {
        try
        {
            ...
            String query= "select * from product where units_per_day = " + View_by_product.units1 + ";";
    ...
    /**
     * Creates new form View_by_product_units
     */
    public View_by_product_units() {
        initComponents();
        print();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Product table by units sold per day");
        ...
        jLabel1.setText("Enter another quantity:");
        ...
        jLabel2.setText("Products with sales per day between:");
        ...
        jLabel4.setText("Products of sales per day less than:");
        ...
        jLabel5.setText("Products of sales per day more than:");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            ...
            String query= "select * from product where units_per_day = " + enter.getText() + ";";
            ResultSet rs = st.executeQuery(query);
...
this.dispose();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try
        {
            ...
            String query= "select * from product where units_per_day > " + enter1.getText() + " and units_per_day < " + enter2.getText() + ";";
            ResultSet rs = st.executeQuery(query);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try
        {
            ...
            String query= "select * from product where units_per_day < " + enter3.getText() + ";";
            ResultSet rs = st.executeQuery(query);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        try
        {
            ...
            String query= "select * from product where units_per_day > " + enter4.getText() + ";";
            ResultSet rs = st.executeQuery(query);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_by_product_units.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
