 ...
 * @author MAHE
 */
public class View_by_factory_name extends javax.swing.JFrame {
    ...
    public void print()
    {
        try
        {
            ...
            String query= "select * from factory, product, waste where factory.f_name = '" + View_by_factory.name1 + "' and product.p_id = factory.p_id and waste.f_id = factory.f_id;";
    ...
    /**
     * Creates new form View_by_factory_name
     */
    public View_by_factory_name() {
        initComponents();
        print();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Factory table by name");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            ...
            String query= "select * from factory, product, waste where factory.f_name = '" + enter.getText() + "' and product.p_id = factory.p_id and waste.f_id = factory.f_id;";
            ResultSet rs = st.executeQuery(query);
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_by_factory_name.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
