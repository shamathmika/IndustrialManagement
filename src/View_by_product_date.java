 ...
 * @author MAHE
 */
public class View_by_product_date extends javax.swing.JFrame {
    ...
    public void print()
    {
        try
        {
            ...
            String query= "select * from product, makes where date_of_sale = '" + d + "' and makes.p_id = product.p_id;";
    ...
    /**
     * Creates new form View_by_product_date
     */
    public View_by_product_date() {
        initComponents();
        print();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Product table by raw material");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            ...
            String query= "select * from product, makes where date_of_sale = '" + enter.getText() + "'and makes.p_id = product.p_id;";
            ResultSet rs = st.executeQuery(query);
...
this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_by_product_date.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
