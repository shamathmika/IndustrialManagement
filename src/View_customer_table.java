 ...
 * @author MAHE
 */
public class View_customer_table extends javax.swing.JFrame {
public void print()
    {
        try
        {
            ...
            String query= "select * from customer, sells, factory where customer.c_id = sells.c_id and sells.f_id = factory.f_id;";
    ...
    /**
     * Creates new form View_customer_table
     */
    public View_customer_table() {
        initComponents();
        print();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_customer_table.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
