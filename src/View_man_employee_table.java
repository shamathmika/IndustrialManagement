 ...
 * @author MAHE
 */
public class View_man_employee_table extends javax.swing.JFrame {
public void print()
    {
        try
        {
            ...
            String query= "select * from employee, factory where employee.f_id = factory.f_id and factory.f_id = " + Manager.f_id + ";";
            ResultSet rs = st.executeQuery(query);
            
            while(rs.next())                                                                         //going to each row
            {
                int d1=rs.getInt("e_id");
                String d2=rs.getString("e_name");
                int d3 = rs.getInt("f_id");
                String d5=rs.getString("phone");
                float d9=rs.getFloat("salary");
    ...
    /**
     * Creates new form View_man_employee_table
     */
    public View_man_employee_table() {
        initComponents();
        print();
    }
    ...
    private void initComponents() {
        ...
        id_view.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Customer ID", "Name", "Factory ID", "Factory Name", "Phone", "Email ID", "Address", "Post", "Salary", "Date Joined", "DOB"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(View_man_employee_table.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
